...
from app.aplicacion.dtos.administrador.obtener_actual_programacion_reponse import (
    ObtenerActualProgramacionResponse,
)
from app.aplicacion.dtos.administrador.obtener_actual_programacion_request import (
    ObtenerActualProgramacionRequest,
)
from app.aplicacion.dtos.administrador.obtener_todo_programacion_response import (
    ObtenerTodoProgramacionResponse,
)
...
class ProgramacionServicio:
    ...
    async def crear(self, tipo: str, usuario_auditoria_id: str) -> str:
        ...
        existe_descarga: bool = (
            await self._programacion_repositorio.verificar_existencia_por_filtros(
                {
    ...
    async def obtener_todos(self) -> list[ObtenerTodoProgramacionResponse]:
        programaciones: list[
            ProgramacionEntidad
        ] = await self._programacion_repositorio.obtener_todos(
            {"estado": base_entidad.ESTADO_ACTIVO}
        )
    ...
    async def obtener_actual(
        self, request: ObtenerActualProgramacionRequest
