...
class UbicacionServicio:
    """
    Servicio para la consulta de ubicaciones.
    """

    @staticmethod
    def __obtener_url_busqueda(nombre_ubicacion: str) -> str:
        """
        Obtiene la url para realizar la busqueda de ubicaciones en mapbox.
        Args:
            nombre_ubicacion: Nombre de la ubicacion a buscar.
        Returns:
            Url para realizar la busqueda de ubicaciones en mapbox.
        """
    ...
    async def obtener_todos(self, request: ObtenerUbicacionRequest) -> list[ObtenerUbicacionResponse]:
        """
        ...
        tipo_lugar = {"country": 6, "place": 12, "locality": 14, "neighborhood": 16, "address": 18, "poi": 18}
        ...
        return [ObtenerUbicacionResponse(
            id=str(uuid.uuid4()),
