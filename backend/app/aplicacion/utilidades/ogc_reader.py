...
def web_map_service(url, version='1.1.1', xml=None, username=None, password=None, parse_remote_metadata=False,
    ...
    Args:
        ...
        version (str): The version of the WMS service.
        xml (str): The XML of the WMS service.
        username (str): The username for authentication.
        password (str): The password for authentication.
        parse_remote_metadata (bool): Whether to parse remote metadata.
        timeout (int): The timeout for the request.
        headers (dict): The headers for the request.
        auth (Authentication): The authentication object.
    Returns:
        WebMapService111: The WebMapService111 instance.
    """
    if auth:
        if username:
            auth.username = username
