                    ...
                    <a-form-model-item label="Unión de línea" prop="lineJoin">
                        <a-select v-model="form.lineJoin">
                            <a-select-option value="round"
                                >Redondeada</a-select-option
                            >
                            <a-select-option value="miter"
                                >Miter</a-select-option
                            >
                            <a-select-option value="bevel"
                                >Bevel</a-select-option
                            >
                        </a-select>
                    </a-form-model-item>
                </a-col>
                <a-col :lg="12" :md="12" :sm="12" :xs="24">
                    <a-form-model-item label="Regla de relleno" prop="fillRule">
                        <a-select v-model="form.fillRule">
                            <a-select-option value="evenodd"
                                >EvenOdd</a-select-option
                            >
                            <a-select-option value="nonzero"
                                >NonZero</a-select-option
                            >
                        </a-select>
                    </a-form-model-item>
                </a-col>
