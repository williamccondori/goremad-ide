            ...
            <div>
                ...
                >
                    ...
                    <a-form-model-item
                        ...
                        prop="temaId"
                        :rules="[
                            { required: true, message: 'Seleccione un tema' },
                        ]"
                    >
                        <a-select
                            v-model="form.temaId"
                    ...
                    <a-form-model-item
                        ...
                        :rules="[
                            {
                                required: true,
                                message: 'Seleccione un objeto geográfico',
                            },
                        ]"
                    >
                        <a-select
...
export default {
    ...
    computed: {
        ...
        gruposDisponibles() {
            return (
                this.temasDisponibles.find(
                    (tema) => tema.id === this.form.temaId
                )?.grupos ?? []
            );
        },
        objetosGeograficosDisponibles() {
            return (
                this.gruposDisponibles.find(
                    (grupo) => grupo.id === this.form.grupoId
                )?.objetos ?? []
            );
        },
    },
    methods: {
        ...
        async consultarInformacionObjetoGeografico() {
            ...
            try {
                this.$iniciarCarga();
                const { data: informacionObjetoGeografico } =
